...
<?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['numero_habitacion'])) {
            ...
            if (empty($errors)){
                echo "<h1 id='exito'>La habitación se ha registrado correctamente</h1>";
                $disabled = "disabled";
                ...
                // Insertar habitación
                insertar_habitacion($numero_habitacion, $capacidad, $precio_noche, $descripcion);
            }
        }
    ?>
        ...
        <div class="principal">
            <div class="intermedio">
                <div class="auxiliar">
                    ...
                    <input type="text" id="numero_habitacion" name="numero_habitacion" value="<?php echo isset($_POST['numero_habitacion']) ? htmlspecialchars($_POST['numero_habitacion']) : ''; ?>" placeholder="Introduzca el número o nombre de la habitación" <?php echo isset($disabled) ? $disabled : ''; ?>>
                ...
                <div class="auxiliar">
                    ...
                    <input type="number" id="capacidad" name="capacidad" value="<?php echo isset($_POST['capacidad']) ? htmlspecialchars($_POST['capacidad']) : ''; ?>" placeholder="Introduzca la capacidad máxima de la habitación" <?php echo isset($disabled) ? $disabled : ''; ?>>
                ...
                <div class="auxiliar">
                    ...
                    <input type="number" id="precio_noche" name="precio_noche" value="<?php echo isset($_POST['precio_noche']) ? htmlspecialchars($_POST['precio_noche']) : ''; ?>" placeholder="Introduzca el precio por noche de la habitación" <?php echo isset($disabled) ? $disabled : ''; ?>>
            ...
            <div class="intermedio">
                <div class="auxiliar">
                    ...
                    <textarea id="descripcion" name="descripcion" placeholder="Escriba una descripción de la habitación" <?php echo isset($disabled) ? $disabled : ''; ?>><?php echo isset($_POST['descripcion']) ? htmlspecialchars($_POST['descripcion']) : ''; ?></textarea>
